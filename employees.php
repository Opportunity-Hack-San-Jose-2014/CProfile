				                ...
				                <div class="col-lg-12">
				                    <div class="panel panel-default">
				                        <div class="panel-heading">
				                            Enter the details of your new Employees here
				                        </div>
					                            ...
					                            <div class="row">
				                                        ...
				                                        <div class="row">
				                                        	...
				                                        	<div class="col-lg-6">
						                                        <div class="form-group">
						                                           ...
						                                           <script>DateInput('txtDateOfJoin', true, 'YYYY-MM-DD')</script>
						                                        </div>
						                                    </div>
				                                        </div>
				                                        <div class="form-group">
					                                ...
					                                <div class="col-lg-6">
				                                        ...
				                                        <div class="form-group">
				                                            ...
				                                            <input name="txtYearsOfExperience" class="form-control" placeholder="Enter years">
				                                        </div>
				                                        <div class="form-group">
				                                            <label>Skills</label>
						                            ...
						                            <div class="row">
						                                <div class="col-lg-12">
					                                        <div class="form-group">
						                                        <button id="butSubmit" type="button" class="btn btn-default" oncl>Create New Employee</button>
...
<script>
	function getEmployees(paramDiv, paramPageId) {
		...
		//alert(reqData);
		$.ajax({
			  url: "http://www.cprofile.org/searchEmp.php",
			  data: reqData
			}).done(function (respData) {
	...
	getEmployees('tableRowsEmployees','');
