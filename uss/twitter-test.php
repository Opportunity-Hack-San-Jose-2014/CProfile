...
//    header('Location: ./uss/clearsessions.php');
//}
/* Get user access tokens out of the session. */
//$access_token = "abcd1234"; //$_SESSION['access_token'];


/* Create a TwitterOauth object with consumer/user tokens. */
//$connection = new TwitterOAuth(CONSUMER_KEY, CONSUMER_SECRET, $access_token['oauth_token'], $access_token['oauth_token_secret']);
$connection = new TwitterOAuth("stuimfiMJgb5QuG04pXtG5JpM", "L0WYyqBiggQX8xJjjx44BDfLWzMqrZrHqgDjbLz4mM6htNZxmc", "65933981-AEiJoN2DZfRbGwHVYkqHB1B1ANczTNjAT6X3sqOBf", "jB4ZEVfAippl6bQvLVkmX8GVc0sQWKx3JEUudRR6rWEhD");
...
echo "User Screen Name: ".$user->screen_name."<br>";
echo "User Created At: ".$user->created_at."<br>";
echo "User Follower Count: ".$user->followers_count."<br>";
echo "User Friends Count: ".$user->friends_count."<br>";
...
if (empty($active) || empty($_GET['confirmed']) || $_GET['confirmed'] !== 'TRUE') {
  ...
  echo '<a href="twitter-test.php?confirmed=TRUE">Continue</a> or <a href="./index.php">go back</a>.';
  exit;
}
...
/* oauth/request_token */
$oauth = new TwitterOAuth("stuimfiMJgb5QuG04pXtG5JpM", "L0WYyqBiggQX8xJjjx44BDfLWzMqrZrHqgDjbLz4mM6htNZxmc");
